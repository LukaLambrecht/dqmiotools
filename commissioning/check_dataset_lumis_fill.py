...
#sys.path.append('../../omsapi') # todo: fix import to a valid OMS API instance
...
if __name__=='__main__':
  ...
  parser.add_argument('-r', '--rawsetname', required=True,
                        help='Name of corresponding RAW data set on DAS')
  parser.add_argument('-o', '--outputfile', required=True,
                        help='Name of json output file to write')
  ...
  # find lumisections by reading the DQMIO files
  runsls = []
