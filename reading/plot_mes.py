...
def maketitle( me ):
  ...
  title = plottools.make_text_latex_safe(me.name)
...
def make1dplot( me ):
  ...
  fig,ax = plottools.plot_hists([hist], title=maketitle(me))
  return (fig,ax)
...
def make2dplot( me ):
  ...
  hist = metools.me_to_nparray( me, integer_values=True )
  fig,ax = plottools.plot_hist_2d(hist, title=maketitle(me))
  return (fig,ax)
...
def makeprofileplot( me ):
  ...
  fig,ax = plottools.plot_hists([values], xlims=xlims, title=maketitle(me))
  return (fig,ax)
...
def make0dplot( me ):
  ...
  fig,ax = plt.subplots()
  text = str(me.data)
  plottools.add_text(ax, text, (0.5, 0.5), 
              fontsize=15,
