...
# **A script for reading (nano)DQMIO files and storing a ME in hdf file format**  
# 
# Run with `python harvest_nanodqmio_to_hdf.py -h` for a list of available options.  
...
if __name__=='__main__':
  ...
  # read arguments
  parser = argparse.ArgumentParser(description='Harvest nanoDQMIO to hdf')
